<template>
  <footer
    class="flex flex-col-reverse md:flex-row md:justify-between items-center w-full border-t px-8 py-5 shadow"
  >
    <div>
...
const presentYear = computed(() => new Date().getFullYear());
</script>
